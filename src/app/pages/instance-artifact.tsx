...
export type InstanceArtifactRedirectPageProps = {
};

export const InstanceArtifactRedirectPage: FunctionComponent<InstanceArtifactRedirectPageProps> = ({}: InstanceArtifactRedirectPageProps) => {
